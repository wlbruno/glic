            	...
            	<div class="col-md-12">
              		<div class="box box-default">
                		<div class="box-header">
                    		<div class="box-tools">
                        		<h3>LICITANTE: {{$caronas->Itensorgao[0]->fornecedores->fornecedor}} <br><strong>CNPJ:</strong> {{$caronas->Itensorgao[0]->fornecedores->cnpj}}</h3>
                        	</div>
                    	</div>
                				...
                				<div class="card card-primary">
                    				<div class="card-header">
                        				<table border="1" class="table table-ordered table-hover">
                                            ...
                                            <tbody>
                                                @foreach($caronas->Itensorgao as $item)
                                                    <tr>
                                                        ...
                                                        @foreach($caronas->Itensorgao as $itemcarona)
                                                            @if($itemcarona->id == $item->id)
                                                              <td>{{$caronas->Carona_orgaos->getQTD($itemcarona->id)->quantidade}}</td>
                                                            @endif
                                                        @endforeach
                                                    </tr>
                                                @endforeach
